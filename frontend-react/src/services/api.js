/**
 * MixMasterAI - API Service
 * =========================
 * Centralized API client for communication with the Flask backend.
 * Migrated from the original api.js to work with React.
 */

const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://api.mixmasterai.app';
